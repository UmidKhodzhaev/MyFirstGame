...
hero_stand = "textures\\player_stand.png"
hero_jump = "textures\\player_jump.png"
hero_run = "textures\\player_run.png"
...
ANIMATION_STAY_RIGHT = [('anim\\StandR\\1.png'),
            ('anim\\StandR\\2.png'),
            ('anim\\StandR\\3.png'),
            ('anim\\StandR\\4.png'),
            ('anim\\StandR\\5.png'),
...
ANIMATION_LEFT = [('anim\\RunL\\1.png'),
            ('anim\\RunL\\2.png'),
            ('anim\\RunL\\3.png'),
            ('anim\\RunL\\4.png'),
            ('anim\\RunL\\5.png'),
